...
/* amh, NEW: verbose_flag */
/*void predict(mxArray *plhs[], const mxArray *prhs[], struct svm_model *model, const int predict_probability) */
void predict(mxArray *plhs[], const mxArray *prhs[], struct svm_model *model, const int predict_probability, const int verbose_flag)
{
		 ...
		 int nrhs, const mxArray *prhs[] )
{
    ...
    int verbose_flag = 1;   /* amh, NEW: verbose_flag */
	...
	if(mxIsStruct(prhs[2]))
	{
		...
		predict(plhs, prhs, model, prob_estimate_flag, verbose_flag);   /* amh, NEW: verbose_flag */
		/* destroy model */
		svm_destroy_model(model);
	}
	else
