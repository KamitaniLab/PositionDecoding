...
for index_filename=1:length(filename)
    load(['results/resultsPositionDecodingBySVR_' filename{index_filename} '.mat'])
...
title('Decoding accuracy with SVR','FontSize',FontSize)
saveas(gcf,'figDecodingAccuracyWithSVR_20170327.pdf','pdf')